...
# Rscript barplot_FCC_AUC_ratio_randommidposdisc.R

script_name <- "barplot_FCC_AUC_ratio_randommidposdisc.R"
...
all_hicds <- all_hicds[  grepl("RANDOMMIDPOSDISC_", all_hicds) ]
...
outFolder <- "BARPLOT_FCC_AUC_RATIO_RANDOMMIDPOSDISC"
