...
# Rscript barplot_with_FCC_fract_randommidposdisc.R
...
outFolder <- "BARPLOT_WITH_FCC_FRACT_RANDOMMIDPOSDISC"
...
rd_ratio_file <- "BARPLOT_FCC_AUC_RATIO_RANDOMMIDPOSDISC/all_dt.Rdata"
stopifnot(file.exists(rd_ratio_file))

auc_ratio_file <- file.path("BARPLOT_FCC_AUC_RATIO_RANDOMMIDPOSDISC", "all_dt.Rdata")
...
outFile <- file.path(outFolder, paste0("all_ds_fcc_auc_randommidposdisc_vs_obs.", plotType))
...
outFile <- file.path(outFolder, paste0("all_ds_coexpr_auc_randommidposdisc_vs_obs.", plotType))
do.call(plotType, list(outFile, height=myHeight, width=myWidth))
par(bty="L")
plot(
...
outFile <- file.path(outFolder, paste0("all_ds_coexpr_vs_fcc_auc_randommidposdisc.", plotType))
do.call(plotType, list(outFile, height=myHeight, width=myWidth))
par(bty="L")
plot(
